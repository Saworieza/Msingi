...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { details: @discipline.details, name: @discipline.name, reported_date: @discipline.reported_date }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { details: @discipline.details, name: @discipline.name, reported_date: @discipline.reported_date }
    assert_redirected_to discipline_path(assigns(:discipline))
  end
