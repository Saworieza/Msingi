...
class PaymentTypesControllerTest < ActionController::TestCase
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post :create, payment_type: { specify_other: @payment_type.specify_other, transaction_id: @payment_type.transaction_id, type: @payment_type.type }
    end
  ...
  test "should update payment_type" do
    patch :update, id: @payment_type, payment_type: { specify_other: @payment_type.specify_other, transaction_id: @payment_type.transaction_id, type: @payment_type.type }
    assert_redirected_to payment_type_path(assigns(:payment_type))
  end
