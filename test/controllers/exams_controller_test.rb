...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { attachment: @exam.attachment, end_date: @exam.end_date, name: @exam.name, passmark: @exam.passmark, start_date: @exam.start_date }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { attachment: @exam.attachment, end_date: @exam.end_date, name: @exam.name, passmark: @exam.passmark, start_date: @exam.start_date }
    assert_redirected_to exam_path(assigns(:exam))
  end
